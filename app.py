...
def save_qualifying_loans(qualifying_loans):
    ...
    # YOUR CODE HERE!
    save_loans = questionary.confirm(
        "Do you want to save your qualifying loans?").ask()
    if save_loans == "Y" or "Yes":
        questionary.path("Path to save file").ask()


# Save qualifying loans as a file
